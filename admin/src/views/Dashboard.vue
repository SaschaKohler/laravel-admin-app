            ...
            >
                <v-card color="grey lighten-4" min-width="350px" flat>
                    <v-toolbar :color="selectedEvent.color">
                        ...
                        <v-spacer/>
                        <v-btn fab color="white" outlined @click="selectedOpen = false">
...
div .v-calendar-weekly__day .v-calendar-weekly__day-label .v-btn .v-btn__content {
    color: #1a202c;
    font-size: 1.2em;
...
div .v-calendar-daily .v-calendar-daily__head .v-calendar-daily_head-day .v-event {
    color: #1a202c;
    font-size: 1.5em;
    color: white;
...
div .v-calendar-daily .v-calendar-daily__head .v-calendar-daily_head-day-label .v-btn .v-btn__content {
    color: #1a202c;
    font-size: 1.7em;
    font-weight: bolder;
