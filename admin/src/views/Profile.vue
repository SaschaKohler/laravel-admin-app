                            ...
                            <v-row>
                                ...
                                <v-col>
                                    <v-text-field
                                        ...
                                        v-model="accountForm.phone1"
                                        required
                                        :error-messages="errorMessages.phone1"
                                    ></v-text-field>
                                </v-col>
                            </v-row>
                        </v-card-text>
...
export default {
    ...
    watch: {
        user: {
            handler(newVal) {
                if (newVal) {
                    let { name, email, address, phone1 } = newVal;
                    this.accountForm = {
                        name,
                        email,
                        address,
            ...
            try {
                if (
                    ...
                    this.$admin.toast.success(
                        this.$t('profile.account_updated')
                    );
                }
            } finally {
        ...
        async changePassword() {
            ...
            try {
                if (
                    ...
                    this.$admin.toast.success(
                        this.$t('profile.password_changed')
                    );
                }
            } finally {
